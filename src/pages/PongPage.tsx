...
const usePongPage = (isPlaying: boolean) => {
    const isLose = () => {
    ...
    return (
        <main className="pong">
            <div className="score">
                ...
                <span className="computer-score">0</span>
            </div>
            <div className="ball" id="ball"></div>
            <div className="left paddle" id="player-paddle"></div>
            <div className="right paddle" id="computer-paddle"></div>
        </main>
    );
};
